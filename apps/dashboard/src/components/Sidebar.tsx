...
const Icons = {
  ...
  Help: (props: any) => (
    <svg viewBox="0 0 24 24" fill="currentColor" {...props}>
      <path
        fillRule="evenodd"
        d="M2.25 12c0-6.215 5.035-11.25 11.25-11.25S24.75 5.785 24.75 12c0 6.215-5.035 11.25-11.25 11.25S2.25 18.215 2.25 12zm11.25-4.5a.75.75 0 01.75.75v2.25H15a.75.75 0 010 1.5h-3.75V12a.75.75 0 01-1.5 0V8.25a.75.75 0 01.75-.75zm0 10.5a.75.75 0 11-1.5 0 .75.75 0 011.5 0z"
        clipRule="evenodd"
      />
    </svg>
  ),
...
export default function Sidebar({ isOpen }: SidebarProps) {
  ...
  const menuItems = [
    { label: 'Dashboard', href: './', icon: 'Dashboard', tooltip: 'Dashboard' },
    { label: 'Orders', href: '/orders', icon: 'Orders', tooltip: 'Orders' },

    { label: 'Menus', href: '/menus', icon: 'Menus', tooltip: 'Menus' },
    {
      label: 'Calendar',
      href: '/calendar',
      icon: 'Calendar',
    ...
    { label: 'Reports', href: '/reports', icon: 'Reports', tooltip: 'Reports' },
    { label: 'Reviews', href: '/reviews', icon: 'Reviews', tooltip: 'Reviews' },
    {
      label: 'Kitchen Display',
      href: '/kds',
      icon: 'Menus',
      tooltip: 'Kitchen Display Systems',
    },
