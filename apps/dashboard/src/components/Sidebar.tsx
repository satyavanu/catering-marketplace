...
export default function Sidebar({ isOpen }: SidebarProps) {
  ...
  const menuItems = [
    ...
    { label: 'Calendar', href: '/calendar', icon: 'Calendar', tooltip: 'Calendar' },
    { label: 'Customers', href: '/customers', icon: 'Customers', tooltip: 'Customers' },
    { label: 'Payments', href: '/payments', icon: 'Payments', tooltip: 'Payments' },
    { label: 'Reports', href: '/reports', icon: 'Reports', tooltip: 'Reports' },
    { label: 'Reviews', href: '/reviews', icon: 'Reviews', tooltip: 'Reviews' },
    { label: 'Settings', href: '/settings', icon: 'Settings', tooltip: 'Settings' },
  ];
