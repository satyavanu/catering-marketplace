    ...
    <>
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? '0.5rem' : '1.5rem' }}>
          {/* Catering Shop Toggle - Hidden on mobile */}
          {!isMobile && (
            <>
              <div
                style={{
          ...
          <div style={{ position: 'relative' }}>
            ...
            >
              ...
              {!isMobile && <ChevronDownIcon style={{ width: '16px', height: '16px', color: '#94a3b8' }} />}
            </button>
            ...
            {userMenuOpen && (
              <div
                style={{
                  ...
                  right: 0,
                  marginTop: '0.75rem',
                  width: isMobile ? 'calc(100vw - 2rem)' : '240px',
                  maxWidth: '240px',
                  backgroundColor: '#ffffff',
                  borderRadius: '12px',
                  boxShadow: '0 20px 25px rgba(0, 0, 0, 0.15)',
              ...
              >
                ...
                <div style={{ borderTop: '1px solid #e2e8f0' }}>
                  ...
                  >
                    <Cog6ToothIcon style={{ width: '18px', height: '18px', flexShrink: 0 }} />
                    <span>Settings</span>
                  </button>
