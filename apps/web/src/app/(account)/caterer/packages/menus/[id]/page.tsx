...
export default function EditMenuPage() {
  ...
  useEffect(() => {
    const menus = JSON.parse(localStorage.getItem('catering_menus') || '[]') as Menu[];
  ...
  const handleSaveMenu = () => {
    ...
    localStorage.setItem('catering_menus', JSON.stringify(updatedMenus));
    ...
    <div style={styles.container}>
      <div style={styles.header}>
        ...
        <div>
          ...
          <p style={styles.subtitle}>Update your menu sections and dishes</p>
        </div>
      </div>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.formGroup}>
          ...
          <input
            type="text"
            placeholder="e.g., North Indian Menu, Vegetarian Delight"
            value={formData.name}
        ...
        <div style={styles.formGroup}>
          ...
          />
          <p style={styles.helperText}>Help customers understand what this menu offers</p>
        </div>
      ...
      <div style={styles.card}>
        ...
        <p style={styles.sectionDescription}>
          Manage sections like Appetizers, Main Course, Desserts, etc.
        </p>
