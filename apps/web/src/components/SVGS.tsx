...
export const StarIcon = () => (
  ...
  export const RupeeIcon = () => (
    <svg width="22" height="22" stroke="#FF8A39" fill="none" strokeWidth="1.8">
      <path d="M12 3H6m6 0a4 4 0 0 1 0 8H6m6-8H6m0 8l8 10" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
...
export const TagIcon = () => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#FF9800" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export const RefreshIcon = () => (
  <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#7C4DFF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
